...
import { generateWrappedData, getPersona } from "@/lib/mock-data";
...
export default async function StoryPage({
  ...
  // Try to get a pre-built persona, otherwise generate random data
  const wrappedData = getPersona(handle) || generateWrappedData(handle);
